...
const copy = {
  es: {
    ...
    formPlaceholderEs: 'Placeholder iframe (ES): pega aquí el iframe del formulario en español.',
    footerLinks: [
      { label: 'Términos', href: '#' },
  ...
  en: {
    ...
    formPlaceholderEn: 'Iframe placeholder (EN): paste the English contact form iframe here.',
    footerLinks: [
      { label: 'Terms', href: '#' },
      { label: 'Privacy', href: '#' },
      { label: 'LinkedIn', href: '#' },
